...
class SentForVerification extends StatefulWidget {
  ...
  @override
  State<SentForVerification> createState() => _SentForVerificationState();
}
...
class _SentForVerificationState extends State<SentForVerification> {
  ...
  void fetchLeadsdata() async {
    ...
    if (userType == "user") {
      ...
      print(userLeads);
      setState(() {
        ListOfLeads = userLeads.where((lead) => lead["LeadID"].length > 1 && lead["VerificationStatus"] == "Sent for Verification").toList();
      });
